# Consulting visual example assets
...
identify it as an AI concept and make clear that it is not evidence of results.
At a 2× page export, text and SVG remain sharp, but the image does not gain
additional source detail; its intended viewing context is a 1080-stage deck.

The cost bridge uses explicitly illustrative values: 100 − 12 − 8 + 5 = 85.
